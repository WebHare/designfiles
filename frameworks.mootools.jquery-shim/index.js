...
var MooToolsAdapter = new Class(
{
  initialize:function(elements)
  {
    ...
    this.elts = new Elements(elements);
  }
,
/**
...
*/
  ...
  css:function(name,value)
  {
    if(value !== undefined)
    {
      this.elts.setStyle(name,value);
      return this;
    }
    else
    {
      return this.elts.getStyle(name);
    }
  }
...
*/
  ...
  {
    console.log(expression, context, typeof expression);
    var elements;
...
window.jQuery.each = function(collection, callback)
{
  //ADDME should also support Objects
  Array.each(collection, function(el, idx) { callback.apply(el, [idx,el]) });
  return this;
}
window.jQuery.fn = {};
window.jQuery.event = {};
